...
(use-package compile-angel
  ...
  (push "/lisp/init-org.el" compile-angel-excluded-files)
  (push "/lisp/init-ai.el" compile-angel-excluded-files)
  (push "/lisp/init-games.el" compile-angel-excluded-files)
